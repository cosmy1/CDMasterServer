 ...
 * 
 * The ditributed Network Object System rely mostly on this
...
public:
	...
	/**
	 * This broadcasts a request to destroy an object on the network.  OnDistrubtedObjectDestruction will be called.
...
protected:
	 ...
	 */
	unsigned long maximumUpdateFrequency, lastBroadcastTime;
	/**
