...
namespace BasicDataStructures
{
	...
	*/
	...
	void CircularLinkedList<CircularLinkedListType>::clear( void )
	{
		if ( this->list_size == 0L )
			...
			if ( this->list_size == 1L )  // {delete root->item; delete root;}
			{
				delete this->root;
			}
	...
	{
		if ( ( this->list_size != 0L ) && ( this->position->next != this->root ) )
			this->position = this->position->next;
	...
	*/ 
	...
	LinkedList<LinkedListType>& LinkedList<LinkedListType>::operator--()
	{
		if ( ( this->list_size != 0L ) && ( this->position != this->root ) )
			this->position = this->position->previous;
