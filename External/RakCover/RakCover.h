...
extern "C" RAKCOVERDLL_API bool _stdcall CoverServerStart(RakServerInterface* theServer, unsigned short AllowedPlayers, unsigned long connectionValidationInteger, int threadSleepTimer, unsigned short port);
...
extern "C" RAKCOVERDLL_API bool _stdcall CoverServerSend(RakServerInterface* theServer, char* data, const long length, PacketPriority priority, PacketReliability reliability, char orderingChannel, PlayerID playerId, bool broadcast);
...
extern "C" RAKCOVERDLL_API bool _stdcall CoverClientConnect(RakClientInterface* theClient, char* host, unsigned short serverPort, unsigned short clientPort, unsigned long connectionValidationInteger, int threadSleepTimer);
...
extern "C" RAKCOVERDLL_API bool _stdcall CoverClientSend(RakClientInterface* theClient, char* data, const long length, PacketPriority priority, PacketReliability reliability, char orderingChannel);
...
extern "C" RAKCOVERDLL_API bool _stdcall CoverPeerSendData(RakPeerInterface* thePeer, char* data, const long length, PacketPriority priority, PacketReliability reliability, char orderingChannel, PlayerID playerId, bool broadcast);
...
namespace RakNet
{
	extern "C" RAKCOVERDLL_API bool _stdcall CoverPeerSendBitStream(RakPeerInterface* thePeer, BitStream* bitStream, PacketPriority priority, PacketReliability reliability, char orderingChannel, PlayerID playerId, bool broadcast);
	...
	extern "C" RAKCOVERDLL_API void _stdcall CoverBitStreamWriteBits(BitStream* theBitStream, unsigned char* input, int numberOfBitsToWrite, bool rightAlignedBits = true);
